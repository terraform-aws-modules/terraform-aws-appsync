module "wrapper" {
  ...
  introspection_config                = try(each.value.introspection_config, var.defaults.introspection_config, "ENABLED")
  ...
  query_depth_limit                   = try(each.value.query_depth_limit, var.defaults.query_depth_limit, 0)
  ...
  resolver_count_limit                = try(each.value.resolver_count_limit, var.defaults.resolver_count_limit, 0)
